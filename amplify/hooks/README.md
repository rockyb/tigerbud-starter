...
Learn more about the script file naming convention, hook parameters, third party dependencies, and advanced configurations [here](https://docs.amplify.aws/cli/usage/command-hooks).
